    ...
    messages: [
      {
        role: 'user',
        content: [
          { type: 'text', text: 'This image is a report of a problem in town summarize it in title of the problem (10 words max) and description of the problem (around 50 words max) and add tags, answer in slovak' },
